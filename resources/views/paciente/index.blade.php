...
@section('content')
    ...
    <!--<div class="row">
            <div class="col-7">-->
                <a href="{{ route('paciente.create') }}" class="btn btn-success mb-3">Registrar nuevo paciente</a>              
                <a href="{{ route('paciente.pdf') }}" class="btn btn-danger mb-3 float-right">Descargar PDF</a>
